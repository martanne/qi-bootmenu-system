...
URL=http://busybox.net/downloads/busybox-1.17.2.tar.bz2 \
...
URL=http://www.brain-dump.org/projects/qi-bootmenu/qi-bootmenu-0.2.tar.gz \
SHA1=a6db655a22ecd274242faae2324036c1e7229d9f \
download || dienow
